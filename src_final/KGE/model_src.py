...
class Complex(KGE):
    def __init__(self, params):
        ...
        #self.ent_embedding = nn.Embedding(self.num_ents, 2 * self.rank)
        #self.rel_embedding = nn.Embedding(self.num_rels, 2 * self.rank)
    ...
    def load_from_ckpt_path(self, ckpt_path):
        ...
        try:
            ...
            self.embeddings[0].data = params['_entity_embedding.weight']
            self.embeddings[1].data = params['_relation_embedding.weight']
